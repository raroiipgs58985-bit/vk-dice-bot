...
QUOTES_RAW = [
    ...
    "Обращаясь спиной к Повелителю Человечества, еретик обращается спиной ко всему человечеству.",
    "Мы готовы ко всему, и мы будем исполнять наш долг, потому что это всё, что у нас осталось.",
    "От бурь и молний, Император, сбереги нас.",
    "Это место наше. Оно даровано нам милостью Бога-Императора. Если мы позволим ему пасть — мы предадим Его доверие и обречём свои души на вечное проклятие.",
    "Всегда делай вид, что чем-то занят. Если офицер увидит, что ты бездельничаешь — добра не жди.",
    "Просто продержитесь ещё немного, парни! Подкрепления уже на подходе.",
    "Отвага и честь!",
    "Победа или смерть!",
    ...
    "Кровью Сангвиния!",
    "Примарх-прародитель. Во славу Твою и во славу Его на земле!",
    "Плоть слаба!",
    "Покайся! Ибо завтра ты умрёшь!",
    "Есть только Император! Он наш щит и наш защитник!",
    "Без жалости! Без сожалений! Без страха!",
    "За духов Соты!",
    "За Императора и Соту!",
    "Горе тебе.",
    "За Итаку!",
    "Первые среди равных!",
    "Мы молот! Копья Императора!",
    "Обагри кровью землю.",
    "Огонь и кость!",
    "Не бойтесь смерти, которую мы воплощаем во имя Его!",
    "Мы не боимся смерти, ибо мы — воплощённая смерть.",
    "Ради тех, кого лелеем — умираем во славе!",
    "Знание — сила, охраняй его.",
    "Никто не упрекнёт нас! Мы — гордость Императора.",
    "Услышь наш рёв.",
    "За Императора! Во имя Искупления!",
    "За Воинов-Богомолов!",
    "Ненависть — надёжнейшее оружие."
]
